...
public interface IOneCar
{
  string CarName { get; set; }
  ObservableCollection<DateTimeSize> DateTimeSizes { get; set; }
}
public class OneCar : BindableBase, INotifyPropertyChanged, IOneCar
{
  ...
  public override string ToString() => String.Format("{0}, {1}", CarName, Size);
